...
public class SysDictDataController {
    ...
    @ApiOperation("查询字典信息")
    @GetMapping
    public Response<PageOutDTO<DictDataOutDTO>> query(@RequestParam @ApiParam("通用查询语句") String query) {
     ...
     */
    @PutMapping("/defs/{id}")
    public Response updateDictDataDef(@PathVariable Integer id, @RequestBody UpdateDictDataDefDTO inParam) {
