...
public class DateUtil {
    ...
    public static String formatFromTimestamp(DateTimeFormatter formatter, Long timestamp) {
        try {
            ...
            log.error("formatFromTimestamp 解析错误: formatter<{}> timestamp<{}>", formatter.toString(), timestamp);
        }
        return null;
    }
    ...
    public static Long localDateFormatToTimestamp(DateTimeFormatter formatter, String StringTime) {
        try {
            ...
            log.error("localDateFormatToTimestamp 解析错误: formatter<{}> timestamp<{}>", formatter.toString(), StringTime);
        }
        return null;
    }
