...
public class DictJsController {
    ...
    public ResponseEntity<byte[]> frontDownload(@RequestBody @Valid DictDownloadInDTO param) throws IOException {
    ...
    public ResponseEntity<byte[]> backDownload(@RequestBody @Valid DictDownloadInDTO param) throws IOException {
