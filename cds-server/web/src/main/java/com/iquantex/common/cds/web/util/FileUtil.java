...
public class FileUtil {
  ...
  public static void writeFile(String fileName, String content, String encoding, boolean overWrite)
      throws IOException {
    writeFile(fileName, content, overWrite, encoding);
  }

  public static void writeFile(String fileName, String content, boolean overWrite, String encoding)
      throws IOException {
  ...
  public static void writeFile(String basePath, String fileName, byte[] fileContent)
      throws IOException {
